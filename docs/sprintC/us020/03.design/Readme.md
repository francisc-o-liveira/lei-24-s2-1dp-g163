...
| 	                                                                                                                          | 	...displaying all available green space types?                   | GreenSpaceUI                 | Pure Fabrication                                                                                                                           |
...
| Step 3:Provides the name, address, area, and selects a green space type		                                                  | 	... receives the data and requests the organization repository to register the new green space.                                                             | RegisterGreenSpaceController | Controller                                                                                                                                 |
