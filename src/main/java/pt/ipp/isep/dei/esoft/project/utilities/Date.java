...
public class Date implements Comparable<Date>, Serializable {
     ...
     * O ano por omissão.
     */
    private static final int YEAR_POR_OMISSAO = 1;

    /**
     * O mês por omissão.
     */
    private static final int MONTH_POR_OMISSAO = 1;

    /**
     * O dia por omissão.
     */
    private static final int DAY_POR_OMISSAO = 1;

    /**
     * Nomes dos dias da semana.
     */
    private static String[] nameDaysOfWeek = {"Domingo", "Segunda-feira",
     ...
     */
    private static String[] nameMonth = {"Inválido", "Janeiro", "Fevereiro",
     ...
     */
    public Date() {
        year = YEAR_POR_OMISSAO;
        month = MONTH_POR_OMISSAO;
        day = DAY_POR_OMISSAO;
    }
