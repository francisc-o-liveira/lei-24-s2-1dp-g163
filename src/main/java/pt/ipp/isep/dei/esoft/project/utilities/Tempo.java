...
public class Tempo implements Comparable<Tempo> {
    ...
    /**
     * Constrói uma instância de Tempo recebendo as horas e os minutos
     *
     ...
     * @param minutos  os novos minutos do tempo.
     */
    public void setTempo(int horas, int minutos) {
        this.horas = horas;
        this.minutos = minutos;
    }
     ...
     */
    public boolean isMaior(int horas, int minutos) {
        Tempo outroTempo = new Tempo(horas, minutos);
