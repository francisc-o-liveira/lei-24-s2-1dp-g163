...
import pt.ipp.isep.dei.esoft.project.core.application.repository.serv.GenerateTeamServClass;
...
class TeamRepositoryTest {
    ...
    void addTeamAndGetTeamListTest() throws CloneNotSupportedException {
        ...
        Collaborator collab2= new Collaborator(" Manel Mendes Silva Oliveira",new Date(2005,10,29), new Date(2024,04,29),"Rua Das Rosas","4630-131","Marco de Canaveses","+351916835384","joaquim.cunha@gmail.com", DocType.Type.CitizenCard,197232131,new JobCategory("Gardener"));
        Collaborator collab3= new Collaborator("Mendes Cunha Manuel Silva Oliveira",new Date(2005,10,29), new Date(2024,04,29),"Rua Das Rosas","4630-131","Marco de Canaveses","+351916835384","joaquim.cunha@gmail.com", DocType.Type.CitizenCard,197232131,new JobCategory("Gardener"));
